...
while True:
    ...
    if command == 'ren':
        ...
        os.system('cd ' + path + ' && mv ' + originalname + ' ' + distname)
        print("File renamed!")
    ...
    if command == 'runcmdasadmin':
        cmdasadmin = input("Enter the command you want to run as admin: ")
        os.system('sudo ' + cmdasadmin)
